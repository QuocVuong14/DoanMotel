...
class ExamController extends Controller
{
    ...
    {
        try{
            //so luong record/1 page => duoc lay tu config
            $limit = $request -> get('limit') ?? config('app.paginate.per_page');  //constan tu khai bao trong config
            $orderBys = [];

            //get column can sort, asc hoac desc tren url
            //vi du /admin/home?column=name?sort=asc
            //gan vao array orderBys => chuyen qua service xu ly
    ...
    function UpdateStatus(Request $request){
        ...
        return $this -> examService -> UpdateStatus($user_id, $status);
    }
...
//        dd($request);
        ...
        return $this -> examService -> updatePassword($user_id, $password);
    }

//    public function component(){
//        $exams = $this -> examService -> getAll() -> items();
//        // dd($exams);
//        return view('guest.components.category.index', compact('exams'));
//    }
